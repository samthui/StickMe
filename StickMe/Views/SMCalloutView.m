...
- (CAAnimation *)animationWithType:(SMCalloutAnimation)type presenting:(BOOL)presenting {
    ...
    if (type == SMCalloutAnimationBounce) {
        ...
        bounceAnimation.values = [NSArray arrayWithObjects:[NSNumber numberWithFloat:0.05], [NSNumber numberWithFloat:1.11245], [NSNumber numberWithFloat:0.951807], [NSNumber numberWithFloat:1.0], nil];
        bounceAnimation.keyTimes = [NSArray arrayWithObjects:[NSNumber numberWithFloat:0.0], [NSNumber numberWithFloat:4.0/9.0], [NSNumber numberWithFloat:4.0/9.0+5.0/18.0], [NSNumber numberWithFloat:1.0], nil];
        ...
        fadeAnimation.fromValue = presenting ? [NSNumber numberWithFloat:0.0] : [NSNumber numberWithFloat:1.0];
        fadeAnimation.toValue = presenting ? [NSNumber numberWithFloat:1.0] : [NSNumber numberWithFloat:0.0];
        ...
        stretchAnimation.fromValue = presenting ? [NSNumber numberWithFloat:0.0] : [NSNumber numberWithFloat:1.0];
        stretchAnimation.toValue = presenting ? [NSNumber numberWithFloat:1.0] : [NSNumber numberWithFloat:0.0];
    ...
    [animation setValue:[NSNumber numberWithBool:presenting] forKey:@"presenting"];
...
@synthesize leftCapImage = _leftCapImage;
@synthesize rightCapImage = _rightCapImage;
@synthesize topAnchorImage = _topAnchorImage;
@synthesize bottomAnchorImage = _bottomAnchorImage;
